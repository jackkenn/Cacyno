        ...
        authStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent I = new Intent(ActivityLogin.this, com.example.demo1.UserActivity.class);
                    startActivity(I);
                } else {
                    ...
                    firebaseAuth.signInWithEmailAndPassword(userEmail, userPaswd).addOnCompleteListener(ActivityLogin.this, new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task) {
                            if (!task.isSuccessful()) {
                                ...
                                startActivity(new Intent(ActivityLogin.this, com.example.demo1.UserActivity.class));
                            }
                        }
                    });
                } else {
